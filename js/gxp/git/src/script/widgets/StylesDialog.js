...
gxp.StylesDialog = Ext.extend(Ext.Container, {
    ...
    /** api: config[addStyleTip] (i18n) */
     addStyleTip: "Agregar nuevo estilo",
    /** api: config[chooseStyleText] (i18n) */
    chooseStyleText: "Seleccionar estilo",
    /** api: config[addStyleText] (i18n) */
     deleteStyleText: "eliminar",
    /** api: config[addStyleTip] (i18n) */
     deleteStyleTip: "Eliminar estilo seleccionado",
    /** api: config[addStyleText] (i18n) */
    ...
    /** api: config[addStyleText] (i18n) */
     addRuleText: "Agregar",
    /** api: config[addStyleTip] (i18n) */
     addRuleTip: "Agregar nueva regla",
    /** api: config[newRuleText] (i18n) */
     newRuleText: "Nueva Regla",
    /** api: config[addStyleText] (i18n) */
     deleteRuleText: "Eliminar",
    /** api: config[addStyleTip] (i18n) */
     deleteRuleTip: "Eliminar regla seleccionada",
    /** api: config[addStyleText] (i18n) */
     editRuleText: "Editar",
    /** api: config[addStyleTip] (i18n) */
     editRuleTip: "Editar regla seleccionada",
    /** api: config[addStyleText] (i18n) */
     duplicateRuleText: "Duplicar",
    /** api: config[addStyleTip] (i18n) */
     duplicateRuleTip: "Duplicar regla seleccioanda",
    /** api: config[cancelText] (i18n) */
     cancelText: "Cancelar",
    /** api: config[saveText] (i18n) */
     saveText: "Guardar",
    /** api: config[stylePropertiesWindowTitle] (i18n) */
     styleWindowTitle: "Estilo de usuarioUser: {0}",
    /** api: config[ruleWindowTitle] (i18n) */
     ruleWindowTitle: "Regla de estilo: {0}",
    ...
    /** api: config[errorMsg] (i18n) */
     errorMsg: "Se produjo un error al guardar el estilo.",
