...
gxp.FeatureEditPopup = Ext.extend(GeoExt.Popup, {
    ...
    /** i18n **/
    closeMsgTitle: 'Guardar cambios?',
    closeMsg: 'Esta entidad tiene cambios sin gardar. ¿Desea guardar los cambios?',
    deleteMsgTitle: '¿Eliminar entidad?',
    deleteMsg: '¿Esta seguro que desea eliminar esta entidad?',
    editButtonText: 'Editar',
    editButtonTooltip: 'Editar esta entidad',
    deleteButtonText: 'Eliminar',
    deleteButtonTooltip: 'Eliminar esta entidad',
    cancelButtonText: 'Cancelar',
    cancelButtonTooltip: 'detener edicion, descartar cambios',
